  ...
  */
  validator: function(formData, rules, checkAll = false) {
    ...
    for (let item of rules) {
      ...
      itemVal = (itemVal === null || itemVal === void 0 ? "" : itemVal).toString();
      if (!key || ruleLen === 0 && validatorLen === 0 || !~rule.indexOf("required") && itemVal.length === 0) {
        continue;
      }
      if (ruleLen) {
...
exports.form = form$1;
//# sourceMappingURL=../../../../.sourcemap/mp-weixin/components/firstui/fui-form/fui-validator.js.map
