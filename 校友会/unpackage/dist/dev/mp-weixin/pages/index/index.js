...
const indexJs = {
  data() {
    return {
      ...
      functionsAccount: [
        { id: 12, icon: "user-settings-line", text: "账号管理", pageName: "accountManagementPage", iconClass: "dark-blue-icon", hasNotification: false },
  ...
  methods: {
    ...
    handleNotificationClick() {
      ...
      common_vendor.index.__f__("log", "at pages/index/index.js:140", `Navigating to: ${url}`);
    },
    /**
     * 点击个人资料
     */
    handleProfileClick() {
      const url = this.getPageUrl("userProfilePage");
      common_vendor.index.navigateTo({ url });
      common_vendor.index.__f__("log", "at pages/index/index.js:149", `Navigating to: ${url}`);
    },
    /**
     * 点击功能项
    ...
    handleFunctionClick(id, name) {
      ...
      if (clickedItem && clickedItem.url) {
        ...
        common_vendor.index.__f__("log", "at pages/index/index.js:166", `Navigating to function: ${name}, URL: ${itemUrl}`);
      } else {
        common_vendor.index.__f__("warn", "at pages/index/index.js:168", `No URL found for function ID: ${id}, Name: ${name}`);
    ...
    applyBackgroundStyles() {
      ...
      try {
        ...
        common_vendor.index.__f__("error", "at pages/index/index.js:236", "设置背景样式失败:", error);
      }
    },
    /**
     * 应用导航栏样式
